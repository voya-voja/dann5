...
const string NotQT::cMark = "~";
const string NotQT::cName = "not";

/**** Factory Creator's of Not operator Qubo Table ****/
Creator<string, QuboTable, NotQT> gNotQTcreator_m(NotQT::cMark);
Creator<string, QuboTable, NotQT> gNotQTcreator(NotQT::cName);
...
Creator<string, Qop, Qnot> gNotOperatorCreator_m(NotQT::cMark);
Creator<string, Qop, Qnot> gNotOperatorCreator(NotQT::cName);
